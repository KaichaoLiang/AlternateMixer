#-------------------------------------------------------------------------
# file: fcos_query_generator_mixqueue.py
# author: kaichao liang
# date: 2022.06.08
# discription: the query generator of Fcos-Mixer together with original bbox
...
class FcosQueryGeneratorMixQueryFix(AnchorFreeHead):
    def __init__(self,
                 num_classes,
                 in_channels,
    ...
    def init_weights(self):
        super(FcosQueryGeneratorMixQueryFix, self).init_weights()
    ...
    def _decode_init_proposals(self, imgs, img_metas):
        ...
        return xyzr, init_content_features
    ...
    def forward_train(self,
        ...
        *bbox define in outs:
        ...
        xyzr0, init_content_features0 = self._decode_init_proposals(x, img_metas)

        xyzr = torch.cat([xyzr,xyzr0],dim=-2)
        init_content_features = torch.cat([init_content_features, init_content_features0],dim =-2)
