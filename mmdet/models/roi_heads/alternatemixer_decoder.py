...
class AlternateMixerDecoder(CascadeRoIHead):
    _DEBUG = -1
    ...
    def __init__(self,
        ...
        super(AlternateMixerDecoder, self).__init__(
            num_stages,
            stage_loss_weights,
    ...
    def _bbox_forward(self, stage, img_feat, query_xyzr, query_content, img_metas):
        ...
        cls_score, delta_xyzr, query_content, img_feat = bbox_head(img_feat, query_xyzr,
                                                         query_content,
        ...
        if DEBUG:
            with torch.no_grad():
                torch.save(
                    bbox_results, 'demo/bbox_results_{}.pth'.format(AlternateMixerDecoder._DEBUG))
                AlternateMixerDecoder._DEBUG += 1
        return bbox_results
