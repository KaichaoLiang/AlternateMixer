...
class AdaptiveSamplingMixingWithPe(nn.Module):
    _DEBUG = 0
    ...
    def __init__(self,
        ...
        super(AdaptiveSamplingMixingWithPe, self).__init__()
    ...
    def forward(self, x, query_feat, query_xyzr, featmap_strides):
        ...
        if DEBUG:
            torch.save(
                sample_points_xyz, 'demo/sample_xy_{}.pth'.format(AdaptiveSamplingMixingWithPe._DEBUG))
        ...
        if DEBUG:
            torch.save(
                sampled_feature, 'demo/sample_feature_{}.pth'.format(AdaptiveSamplingMixingWithPe._DEBUG))
            AdaptiveSamplingMixingWithPe._DEBUG += 1
...
class AdaMixerDecoderStageWithPe(BBoxHead):
    _DEBUG = -1
    ...
    def __init__(self,
        ...
        super(AdaMixerDecoderStageWithPe, self).__init__(
        ...
        self.sampling_n_mixing = AdaptiveSamplingMixingWithPe(
    ...
    @torch.no_grad()
    def init_weights(self):
        super(AdaMixerDecoderStageWithPe, self).init_weights()
    ...
    def forward(self,
        ...
        AdaMixerDecoderStageWithPe._DEBUG += 1
