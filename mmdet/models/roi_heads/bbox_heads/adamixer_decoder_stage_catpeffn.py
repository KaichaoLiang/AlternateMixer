...
class AdaptiveSamplingMixingCatPeFFN(BaseModule):
    _DEBUG = 0
    ...
    def __init__(self,
        ...
        super(AdaptiveSamplingMixingCatPeFFN, self).__init__()
    ...
    def init_weights(self):
        super(AdaptiveSamplingMixingCatPeFFN, self).init_weights()
    ...
    def forward(self, x, query_feat, query_xyzr, cat_feats, cat_pes, featmap_strides):
        ...
        if DEBUG:
            torch.save(
                sample_points_xyz, 'demo/sample_xy_{}.pth'.format(AdaptiveSamplingMixingCatPeFFN._DEBUG))
        ...
        if DEBUG:
            torch.save(
                sampled_feature, 'demo/sample_feature_{}.pth'.format(AdaptiveSamplingMixingCatPeFFN._DEBUG))
            AdaptiveSamplingMixingCatPeFFN._DEBUG += 1
...
class AdaMixerDecoderStageCatPeFFN(BBoxHead):
    _DEBUG = -1
    ...
    def __init__(self,
        ...
        super(AdaMixerDecoderStageCatPeFFN, self).__init__(
        ...
        self.sampling_n_mixing = AdaptiveSamplingMixingCatPeFFN(
    ...
    @torch.no_grad()
    def init_weights(self):
        super(AdaMixerDecoderStageCatPeFFN, self).init_weights()
    ...
    def forward(self,
        ...
        AdaMixerDecoderStageCatPeFFN._DEBUG += 1
