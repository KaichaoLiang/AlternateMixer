...
class CrossGCN(nn.Module):
    ...
    def init_weights(self):
        #nn.init.zeros_(self.connect_projector_l1.weight)
        #nn.init.zeros_(self.connect_projector_l2.weight)
        nn.init.zeros_(self.weight_projector.weight)
        nn.init.zeros_(self.matrix_projector.weight)
...
class AdaMixerDecoderGCNWrapperStage3(BBoxHead):
    _DEBUG = -1
