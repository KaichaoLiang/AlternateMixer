...
def sampling_each_level_alternate(sample_points: torch.Tensor,
    ...
    sample_points = sample_points.reshape(B,n_queries, n_groups*n_points,2)
    print('mark sample shape',sample_points.shape,B,n_queries,n_groups,n_points)
    weight = weight.view(B, n_groups, n_queries, n_points).permute(0,2,1,3).reshape(B, n_queries,-1)
