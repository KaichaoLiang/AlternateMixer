...
class AdaptiveSamplingMixingWithPeAbsolute(nn.Module):
    _DEBUG = 0
    ...
    def __init__(self,
        ...
        super(AdaptiveSamplingMixingWithPeAbsolute, self).__init__()
    ...
    def forward(self, x, query_feat, query_xyzr, featmap_strides):
        ...
        if DEBUG:
            torch.save(
                sample_points_xyz, 'demo/sample_xy_{}.pth'.format(AdaptiveSamplingMixingWithPeAbsolute._DEBUG))

        sampled_feature, _ = sampling_3d(sample_points_xyz, x,
                                         featmap_strides=featmap_strides,
                                         n_points=self.in_points,
                                         )
        # relative position encodering
        ...
        if DEBUG:
            torch.save(
                sampled_feature, 'demo/sample_feature_{}.pth'.format(AdaptiveSamplingMixingWithPeAbsolute._DEBUG))
            AdaptiveSamplingMixingWithPeAbsolute._DEBUG += 1
...
class AdaMixerDecoderStageWithPeAbsolute(BBoxHead):
    _DEBUG = -1
    ...
    def __init__(self,
        ...
        super(AdaMixerDecoderStageWithPeAbsolute, self).__init__(
        ...
        self.sampling_n_mixing = AdaptiveSamplingMixingWithPeAbsolute(
    ...
    @torch.no_grad()
    def init_weights(self):
        super(AdaMixerDecoderStageWithPeAbsolute, self).init_weights()
    ...
    def forward(self,
        ...
        AdaMixerDecoderStageWithPeAbsolute._DEBUG += 1
